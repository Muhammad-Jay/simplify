...
export default function AboutUs() {
    ...
    return (
        <section ref={aboutRef} id={'about'} className="relative w-full overflow-hidden pt-20">
            {/*<Spotlight*/}
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
                ...
                <motion.div
                    ...
                    <h1
                        className="bg-gradient-to-r from-foreground/80 via-foreground to-foreground/80 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-5xl md:text-6xl">
                        {aboutData.title}
                    </h1>
                ...
                <div ref={missionRef} className="relative mx-auto mb-24 max-w-7xl">
                    <motion.div
                        ...
                        animate={
                            missionInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 60 }
                        }
                        transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
                        className="relative z-10 grid gap-12 md:grid-cols-2">
                        <motion.div
                            whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
                            className="group relative block overflow-hidden rounded-md md:rounded-lg !border-2 p-10 bd backdrop-blur-3xl">
                            ...
                            <div className="space-y-4">
                                <h2
                                    className="mb-4 bg-gradient-to-r from-primary/90 to-primary/70 bg-clip-text text-3xl font-bold text-red-400">
                                    Our Mission
                                </h2>
                        ...
                        <motion.div
                            whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
                            className="group relative block overflow-hidden rounded-md md:rounded-lg !border-2 bd p-10 backdrop-blur-3xl">
                            <div
                                className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-500/5 backdrop-blur-sm">
                                <Target className="h-8 w-8 text-blue-500" />
                            </div>

                            <h2
                                className="mb-4 bg-gradient-to-r from-blue-500/90 to-blue-500/70 bg-clip-text text-3xl font-bold text-transparent">
                                Our Vision
                            </h2>
                ...
                <div ref={valuesRef} className="mb-24">
                    <motion.div
                        ...
                        <h2
                            className="bg-gradient-to-r from-foreground/80 via-foreground to-foreground/80 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-4xl">
                            Our Core Values
                        </h2>
